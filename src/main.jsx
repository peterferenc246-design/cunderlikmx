...
const copy = {
  sk: {
    ...
    cards: [["Pre začiatočníkov", "Postoj na motocykli, plyn, brzdenie, rozjazd, zatáčanie a bezpečné návyky."], ["Technika jazdy", "Stopy v zákrutách, práca s telom, štarty, malé skoky a čítanie trate."], ["Individuálny tréning", "Tréning prispôsobený veku, skúsenostiam, motocyklu a osobnému cieľu jazdca."]],
